...
<head>
    ...
    <style>
        ...
        /* Theme 2 - Modern Teal/Cyan Design */
        body {
        ...
        .hero-section {
            background: linear-gradient(135deg, #20c997 0%, #17a2b8 50%, #0dcaf0 100%);
            color: white;
        ...
        .product-card:hover {
            ...
            box-shadow: 0 12px 24px rgba(32, 201, 151, 0.2);
        }
        .footer {
...
<body class="d-flex flex-column min-vh-100 bg-light">
    @include('themes.theme2.partials.nav')
    ...
    @include('themes.theme2.partials.footer')
